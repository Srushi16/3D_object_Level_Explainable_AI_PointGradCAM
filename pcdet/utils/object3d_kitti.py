...
def get_objects_from_label_str(label_str):
    """New function: read from string (for zip files)"""
    lines = label_str.strip().split('\n')
    objects = [parse_line(line) for line in lines if line.strip()]
    return objects
